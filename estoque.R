...
# Drop tables
# dbGetQuery(tdConnection, 'drop table dev_acc.pnadc_estoque_subst_t')
# dbGetQuery(tdConnection, 'drop table dev_acc.pnadc_estoque_subst_f')
# dbGetQuery(tdConnection, 'drop table dev_acc.pnadc_estoque_t')
# dbGetQuery(tdConnection, 'drop table dev_acc.pnadc_estoque_f')
# dbGetQuery(tdConnection, 'drop table dev_acc.pnadc_estoque_grst_t')
# dbGetQuery(tdConnection, 'drop table dev_acc.pnadc_estoque_grst_f')
# dbGetQuery(tdConnection, 'drop table dev_acc.pnadc_txpart_subst_f')
# dbGetQuery(tdConnection, 'drop table dev_acc.pnadc_txpart_subst_t')
# dbGetQuery(tdConnection, 'drop table dev_acc.pnadc_txpart_grst_f')
# dbGetQuery(tdConnection, 'drop table dev_acc.pnadc_txpart_grst_t')
...
estoque(ano, trimestre)
tx_participacao(ano, trimestre)
